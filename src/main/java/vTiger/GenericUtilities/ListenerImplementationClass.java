...
/**
 * This class provides implementation to the ITestListner Interface of TestNG
 * @author Jagadeesh
 *
 */
public class ListenerImplementationClass implements ITestListener 
{
	...
	public void onTestStart(ITestResult result) {	//IQ QUE:-these are the 9 unimplemented methods of listener interface
